...
class ConflictDetector:
    def __init__(self, ha_client: HomeAssistantClient, user_id: str, db_module: Any):
        ...
        if type_of_front_end == "llm":
            ...
            if not self._is_conflict_present(unique_id_conflict): # Controllo sull'ID univoco
                self.conflicts.append({
                    "type": "conflict",
                    "id_conflict": id_conflict, # Considerare un UUID o un meccanismo di ID più robusto
